...
public class WebSiteCooperativeLogoService {
	...
	@Value("${application.webSiteCooperativeLogo.add}")
	private String addUrl;
	@Value("${application.webSiteCooperativeLogo.findAll}")
	private String findAllUrl; 
	@Value("${application.webSiteCooperativeLogo.delete}")
	private String deleteUrl; 
	@Value("${application.webSiteCooperativeLogo.query}")
